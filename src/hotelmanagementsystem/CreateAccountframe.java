...
Connection con=null;
    ...
    try{
    String sql="INSERT INTO CREATEACCOUNT (CNIC,FNAME,LNAME,USERNAME,PASSWORD,PHONENO,ADDRESS,BIRTHDATE)VALUES (?,?,?,?,?,?,?,?)";
    con=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:orcl", "hr", "hr");
    
    pst=con.prepareStatement(sql);
    String cnic=jTextField1.getText();
    pst.setInt(1, Integer.parseInt(cnic));
    pst.setString(2, jTextField6.getText());
    pst.setString(3, jTextField2.getText());
    pst.setString(4, jTextField3.getText());
    pst.setString(5, jPasswordField1.getText());
    java.sql.Date sDate = new java.sql.Date(jDateChooser2.getDate().getTime());
...
if(jPasswordField1.getText().equals(jPasswordField2.getText())){
    ...
    this.dispose();
        ...
        JOptionPane.showMessageDialog(null, "RetypePassword");
...
private Loginframe loginframe;
    void disableloginframe(Loginframe loginframe) {
